...
# model = tf.keras.models.load_model('./pocus/static/cnn/binary-holistic-ldmk-3-categorical-softmax-epo20.h5')
model = tf.keras.models.load_model('./pocus/static/cnn/binary-holistic-ldmk-3-binary-sigmoid-epo20.h5')
...
def predict():
    ...
    for i in images:
        ...
        with mp_holistic.Holistic(static_image_mode=True, model_complexity=2, enable_segmentation=True, refine_face_landmarks=True) as holistic:
            # gray scale
            ...
            mp_drawing.draw_landmarks(annotated_image, results.pose_landmarks, mp_holistic.POSE_CONNECTIONS, landmark_drawing_spec=mp_drawing_styles.get_default_pose_landmarks_style(), )  # (1920, 1920, 3)

            # cv2.imwrite(f'./{i}', annotated_image)
